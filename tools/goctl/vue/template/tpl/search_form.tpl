<template>
    <search-pad @reset="onReset" @search="doDebounceSearch">
        <el-form ref="refForm" size="small" :inline="true" :model="formData" :rules="formRules" class="px-2">
            <responsive-row>
                <responsive-col>
                    <el-form-item :label="$t('{{.lowerStartCamelObject}}.search.dateRange')">
                        <date-range-picker v-model="formData.date" @change="onSearch" />
                    </el-form-item>
                </responsive-col>
                <responsive-col>
                    <el-form-item :label="$t('{{.lowerStartCamelObject}}.itemFields.status')">
                ...
                <responsive-col>
                    <el-form-item :label="$t('{{.lowerStartCamelObject}}.itemFields.id')" prop="ids">
                        <el-input
                            v-model="formData.ids"
                            class="!w-full"
                            :placeholder="$t('{{.lowerStartCamelObject}}.search.placeholderId')"
                            clearable
                ...
                <responsive-col>
                    <el-form-item :label="$t('{{.lowerStartCamelObject}}.itemFields.name')">
                        <el-input
                            v-model="formData.name"
                            :placeholder="$t('{{.lowerStartCamelObject}}.search.placeholderName')"
                            clearable
                            @input="doDebounceSearch"
                        />
                    </el-form-item>
                ...
                <responsive-col>
                    <el-form-item :label="$t('{{.lowerStartCamelObject}}.itemFields.code')">
                        <el-input
                            v-model="formData.code"
                            :placeholder="$t('{{.lowerStartCamelObject}}.search.placeholderCode')"
                            clearable
                            @input="doDebounceSearch"
                        />
                    </el-form-item>
